...
@ComponentScan(basePackages = { "com.ps.RESTful", "com.ps.services", "com.ps.util" })
@EnableJpaRepositories(basePackages = {
		"com.ps.services.dao.repository.master" }, entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
