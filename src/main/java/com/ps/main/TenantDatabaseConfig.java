...
@ComponentScan(basePackages = { "com.ps.RESTful", "com.ps.services", "com.ps.util", "com.ps.config.tenant" })
@EnableJpaRepositories(basePackages = {
		"com.ps.services.dao.repository.tenant" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		properties.put(org.hibernate.cfg.Environment.DIALECT, "org.hibernate.dialect.SQLServerDialect");
